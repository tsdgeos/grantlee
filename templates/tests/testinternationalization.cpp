...
void TestInternationalization::testStrings_data()
{
  ...
  QTest::newRow("string-08")
      ...
      << QString::fromUtf8("1 fichier copié dans destinationFolder") << QString()
  ...
  QTest::newRow("string-09")
      ...
      << QString::fromUtf8("2 fichiers copiés dans destinationFolder") << QString()
      << QStringLiteral("%n files copied to %1")
...
void TestInternationalization::testLocalizedTemplate_data()
{
  ...
  QTest::newRow("fragment-01")
      ...
      << QString::fromUtf8("1" FR_THOUSAND_SEPARATOR "000 messages au 07/05/2005, la fraction du "
  ...
  QTest::newRow("fragment-03")
      ...
      << QString::fromUtf8("1" FR_THOUSAND_SEPARATOR "000 -- 07/05/2005 -- 0,60 -- 4,80 -- 04:05 -- "
                        "07/05/2005 04:05")
      << dict;
  ...
  QTest::newRow("fragment-04")
      ...
      << QString::fromUtf8(
             ...
             "04:05"
             "Aujourd&#39;hui"
             " -- 1" FR_THOUSAND_SEPARATOR "000 -- 07/05/2005 -- 0,60 -- 4,80 -- 04:05 -- "
             "07/05/2005 "
             "04:05")
      << QString::fromUtf8(
             "Today"
  ...
  QTest::newRow("fragment-06")
      ...
      << QStringLiteral("1.000") << QString::fromUtf8("1" FR_THOUSAND_SEPARATOR "000")
      << dict;
  ...
  QTest::newRow("fragment-07")
      ...
      << QString::fromUtf8("1" FR_THOUSAND_SEPARATOR "000 0,60 4,80") 
      << dict;
